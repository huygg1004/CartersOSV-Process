    ...
    public class CartersOSVInboundEDI856Process : DataSolutionsServiceBase
    {
        ...
        public DOC856 GenerateXML856(string outputPath, string ediFileName, EdiDocument ediDocument, EdiDocument ediDocument2, EdiDocument ediDocumentO)
        {
            ...
            try
            {
                    ...
                    if (ediDocument.Segments[i].Name == "HL")
                    {
                        ...
                        if (ediDocument.Segments[i].Values[3] == "S")
                        {
                            ...
                            if (ediDocument.Segments[i + 1].Values[6] == "G")
                            {
                                ...
                                shipLevel.EXTRA = new List<DataSolutions.DataModels.Xml.ShipNotice.EXTRA> { grossWeightUOM_Extra, EXTRA_999DOCNAT }.ToArray();
                            }
                            else if (ediDocument.Segments[i + 1].Values[6] == "N")
                            {
                                ...
                                shipLevel.EXTRA = new List<DataSolutions.DataModels.Xml.ShipNotice.EXTRA> { netWeightUOM_Extra, EXTRA_999DOCNAT }.ToArray();
                            }
                ...
                translatedDoc856.EXTRA = new List<DataSolutions.DataModels.Xml.ShipNotice.EXTRA> { EXTRA_999ISASID, EXTRA_999ISARID, EXTRA_999ISADT, EXTRA_999ISATM, EXTRA_999ISA, EXTRA_999GS, EXTRA_999ST }.ToArray();
                #endregion
